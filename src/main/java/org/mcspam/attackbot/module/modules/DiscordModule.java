...
import org.mcspam.attackbot.listeners.MessageListener;
import org.mcspam.attackbot.listeners.ReadyListener;
...
public class DiscordModule extends AbstractModule {
    ...
    public void onEnable() {
        ...
        try {
            ...
            jda.getPresence().setGame(Game.playing("mcspam.org | !help"));
